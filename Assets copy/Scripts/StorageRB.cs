...
public class StorageRB : MonoBehaviour
{
    ...
    class RB
    {
        ...
        public class Node
        {
            ...
            public Node(int data, Vector3 coordinates, string name)
            {
                this.data = data;
        ...
        public void Insert(int item, Vector3 coordinates, string name)
        {
            Node newItem = new Node(item, coordinates, name);
            if (root == null)
            {
                root = newItem;
        ...
        /// Finds the minimum node in the subtree of a given node
